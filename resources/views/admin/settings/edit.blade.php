...
{!! Form::model($settings, array('class' => 'form-horizontal', 'id' => 'form-with-validation', 'method' => 'PATCH', 'route' => array(config('quickadmin.route').'.settings.update', $settings->id))) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('value', old('value',$settings->value), array('class'=>'form-control')) !!}
